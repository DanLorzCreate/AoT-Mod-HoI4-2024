...
NDiplomacy = {
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.15,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.15,				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
	VOLUNTEERS_RETURN_EQUIPMENT = 0.95,				-- Returning volunteers keep this much equipment
	VOLUNTEERS_TRANSFER_SPEED = 8,					-- days to transfer a unit to another nation
	...
	TENSION_CB_WAR = 2.5,								-- Amount of tension generated by a war with a CB
	TENSION_ANNEX_NO_CLAIM = 1,						-- Amount of tension generated by annexing a state you don't have claims on
	TENSION_ANNEX_CLAIM = 0.25,						-- Amount of tension generated by annexing a state you DO have claims on
	TENSION_ANNEX_CORE = 0,							-- Amount of tension generated by annexing a state that is your core
	TENSION_PUPPET = 0.30,							-- Amount of tension generated by puppeting (per state)
	TENSION_FORCE_GOVERNMENT = 0.25,                -- Amount of tension generated by forcing government (per state)
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.005,			-- Amount of tension generated for each sent division
	...
	TENSION_TAKE_ONE_CAPITAL_SHIP = 0.15,			-- Amount of tension generated by 1 take navy peace action
	TENSION_DEMILITARIZE_ZONE = 0.15,				-- Amount of tension generated by stacking demilitarize zone on 1 state, multiplied with the state base threat
	...
	TENSION_CAPITULATE = 0.30,						-- Scale of the amount of tension created by a countries capitulation.
...
NCountry = {
	EVENT_PROCESS_OFFSET = 35,						-- Events are checked every X day per country or state (1 is ideal, but CPU heavy)
	BASE_RESEARCH_SLOTS = 2,						-- Base number of research slots per country.
	POPULATION_YEARLY_GROWTH_BASE = 0.045,			-- basic population growth per year, used for monthly manpower gain
	...
	BASE_SURRENDER_LIMIT = 0.85,						-- Base level of occupation required for country surrender
...
NResistance = {
	...
	INITIAL_STATE_COMPLIANCE = 0.02,							-- initial compliance percentage of a state once it is captured
...
NPolitics = {
	...
	ARMY_LEADER_COST = 4,					-- command power cost for recruiting new leaders, 'this value' * number_of_existing_leaders_of_type
...
NMilitary = {
	...
	PROMOTE_LEADER_CP_COST = 25.0,					-- cost of promoting a leader
...
NAI = {
	...
	MAX_VOLUNTEER_ARMY_FRACTION = 0.35,			-- Countries will not send more than their forces time this number to aid another country
	...
	AT_WAR_THREAT_FACTOR = 5.0,					-- How much increase in threat does AI feel for being in war against osmeone
	NEIGHBOUR_WAR_THREAT_FACTOR = 4.10, 		-- How much increase in threat does AI feel against neighbours who are at war
	POTENTIAL_ALLY_JOIN_WAR_FACTOR = 400, 		-- How much increase in threat does AI feel against neighbours who are allied against one of our enemies
	POTENTIAL_FUTURE_ENEMY_FACTOR = 400, 		-- How much increase in threat does AI feel against neighbours who at war with our allies
	NEUTRAL_THREAT_PARANOIA = 150,				-- How scared neutrals are of everyone
	DIFFERENT_FACTION_THREAT = 300,				-- Threat caused by not being in the same faction
	...
	SEND_VOLUNTEER_EVAL_BASE_DISTANCE = 125.0,  -- How far away it will evaluate sending volunteers if not a major power
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 0.85, 	-- How willing major powers are to send volunteers.
	...
	RELATIVE_STRENGTH_TO_INVADE = 0.07,			-- Compares the estimated strength of the country/faction compared to it's enemies to see if it should invade or stay at home to defend.
	RELATIVE_STRENGTH_TO_INVADE_DEFENSIVE = 0.3,-- Compares the estimated strength of the country/faction compared to it's enemies to see if it should invade or stay at home to defend, but while being a defensive country.
	...
	CASUALTY_RATIO_TO_PULL_EXPEDITIONARIES_BACK = 0.2,			-- AI will pull expeditioniries back if its casualties is aboce this ratio compared to their total deployed manpower
	CASUALTY_RATIO_TO_NOT_SEND_EXPEDITIONARIES = 0.10,			-- AI will not send expeditioniries if its casualties is aboce this ratio compared to their total deployed manpower

	SURRENDER_LEVEL_TO_PULL_EXPEDITIONARIES_BACK = 0.4,			-- AI will pull expeditioniries back if its surrender level is above this ratio
	SURRENDER_LEVEL_TO_NOT_SEND_EXPEDITIONARIES = 0.20,			-- AI will not send expeditioniries if its surrender level is above this ratio
	...
	ENEMY_NAVY_STRENGTH_DONT_BOTHER = 3.5,				-- If the enemy has a navy at least these many times stronger that the own, don't bother invading
...
NOperatives = {
	AGENCY_CREATION_DAYS = 28,						-- Number of days needed to create an intelligence agency
	AGENCY_UPGRADE_DAYS = 21,						-- Number of days needed to upgrade an intelligence agency
